...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "sync_categories": {
        ...
        # Zsh Profile generated by `sccs convert fish-to-zsh` (disabled by
        # default). Activation on the target machine is a one-time manual
        # `source ~/.config/zsh/zshrc` line in ~/.zshrc — SCCS never edits
        # ~/.zshrc itself.
        "zsh_config": {
            "enabled": False,
            "description": "Zsh profile generated from fish config (fish-to-zsh)",
            "local_path": "~/.config/zsh",
            "repo_path": ".config/zsh",
            "sync_mode": "bidirectional",
            "item_type": "file",
            "include": [
                "zshrc",
