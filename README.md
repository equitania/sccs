...
**Version:** 2.58.2 · **Lizenz / License:** AGPL-3.0 · **Python:** ≥ 3.10
...
- 🤖 **OpenAI-Codex-Integration** *(v2.53.0)* — `sccs integrations codex` exportiert Claude-Artefakte one-way in die Codex CLI: Skills verbatim → `~/.agents/skills/` (identisches agentskills.io-Format), Agents → `~/.codex/agents/*.toml` (Frontmatter→TOML, Modell + Reasoning-Effort gemappt, read-only-Toolsets → `sandbox_mode`), Commands als Codex-Skills verpackt (Codex-Prompts sind deprecated). Kollisionsschutz: echte Skills gewinnen immer gegen gleichnamige Commands → [docs/usage/codex.md](docs/usage/codex.md)
